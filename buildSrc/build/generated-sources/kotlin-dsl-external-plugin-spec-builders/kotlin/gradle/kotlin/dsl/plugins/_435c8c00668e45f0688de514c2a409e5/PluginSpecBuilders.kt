...
package gradle.kotlin.dsl.plugins._435c8c00668e45f0688de514c2a409e5
...
/**
 * The `com.github.node-gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGithubNode-gradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.github.node-gradle`.
 */
internal
val `ComGithubPluginGroup`.`node-gradle`: `ComGithubNode-gradlePluginGroup`
    get() = `ComGithubNode-gradlePluginGroup`(plugins)


/**
 * The `com.github.node-gradle.node` plugin implemented by [com.github.gradle.node.NodePlugin].
 */
internal
val `ComGithubNode-gradlePluginGroup`.`node`: PluginDependencySpec
    get() = plugins.id("com.github.node-gradle.node")
...
/**
 * The `io.quarkus` plugin implemented by [io.quarkus.gradle.QuarkusPlugin].
 */
internal
val `IoPluginGroup`.`quarkus`: PluginDependencySpec
    get() = plugins.id("io.quarkus")
...
/**
 * The `org.kordamp` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgKordampPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.kordamp`.
 */
internal
val `OrgPluginGroup`.`kordamp`: `OrgKordampPluginGroup`
    get() = `OrgKordampPluginGroup`(plugins)


/**
 * The `org.kordamp.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgKordampGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.kordamp.gradle`.
 */
internal
val `OrgKordampPluginGroup`.`gradle`: `OrgKordampGradlePluginGroup`
    get() = `OrgKordampGradlePluginGroup`(plugins)


/**
 * The `org.kordamp.gradle.base` plugin implemented by [org.kordamp.gradle.plugin.base.BasePlugin].
 */
internal
val `OrgKordampGradlePluginGroup`.`base`: PluginDependencySpec
    get() = plugins.id("org.kordamp.gradle.base")


/**
 * The `org.kordamp.gradle.jandex` plugin implemented by [org.kordamp.gradle.plugin.jandex.JandexPlugin].
 */
internal
val `OrgKordampGradlePluginGroup`.`jandex`: PluginDependencySpec
    get() = plugins.id("org.kordamp.gradle.jandex")
